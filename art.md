...
It's important that the decision to drop a strat should be done outside of the actual run, not during a run because you're on a good pace and don't want to throw the run. That's being focused on the time and not the performance. Your fullgame runs should be a commitment of the plan you want to execute on. The pressure of nerves is a completely valid factor to consider when dropping a strat, but this should be woven into the plan beforehand.
