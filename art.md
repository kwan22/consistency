...
The decision to drop a strat should be done outside of the actual run, not during a run because you're on a good pace and don't want to throw the run. That's being focused on the time and not the performance. Your fullgame runs should be a commitment of the plan you want to execute on, and confidence in your stratset is key. During runs, you may find it hard to hit hard strats while handling nerves on a good pace: dropping a strat for nerve control is understandable, but you should converge on a decision and stick to it during fullgame.
