...
Mental load is a major factor for my bias towards safe strats. My personal style is to start with a set of easy strats just to give myself a foundation. Once the foundation is set, I look to gradually add optimizations. The key for me is to not learn too many new things at once. I write down a list of things I want to add or improve, and practice those specific bits, with and without context. Once I feel mentally saturated on the amount of new material, I commit to a hard cutoff of learning. I purposely leave some timesave on the table for me to come back to another time, even if it might be "free." The immediate next goal is to evaluate if I actually learned the new material. For this, I just send fullgame. I may find that some strats need more practice, maybe some strats I'm not ready for yet. And that's okay if I need to drop some stuff, I'll come back when I'm stronger. After running fullgame and performing maintenance in between until satisfaction, I will look back at my stratset and movement and re-evaluate anything I want to improve. And the cycle begins anew. 
...
In principle, once you identify a problem strat (I call this putting it on the chopping block), there are only 2 options: fix it or drop it. Unfortunately I cannot say too much on how to choose, this is a conversation you have to candidly have with yourself. For the statistically inclined, maybe you can try to look at average return on timesave, but I would generally recommend to just feel it out and make a judgment call. There is no right answer, but I will say that it is so common to find improvement by dropping problematic strats and shifting your mental energy elsewhere. **Dropping a hard strat in favor of an easier one doesn't mean giving up or admitting defeat. It just means you need to focus your attention elsewhere and need a placeholder.** You can always come back and revisit at any time. I've lost count of the amount of times I've been able to easily pick up a strat that I used to struggle with just by becoming better at the game, despite never practicing the harder strat in the time between. 
