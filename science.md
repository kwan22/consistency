...
## Transitions
  ...
  > The x-axis is really a "Time from hyper start upon reaching the transition", which has a 1-1 correspondence with distance from transition. 
