...
<img src="./media/science/3b_start_jumprelease.webp" width="480"/>
  ...
  Getting the early activation on the long vertical block FW-SG-NoDTS can be quite tricky since a jump release is required when over the falling spring block. I aim to grab the lower half of the spring block
