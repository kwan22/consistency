...
> Aiming the exit of the previous room to set up the eyeball entry to be as fast and consistent as possible to compensate for sacrificing a bhop and to reduce the space of possible trajectories. The red dashed line indicates the boundary where I aim to have Madeline be fully on the right side of. The blue arrow points at the 2nd dash silhouette that provides some immediate feedback for my DashCD on transition.
