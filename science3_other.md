...
> Note the change in elevation in the horizontal dash silhouettes. The horizontal dashes were slightly below but close enough to the floor height that the game allows us to dash onto the floor.
